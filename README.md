...
На графике все семь кривых отрисовываются одновременно своими цветами (`theme/MethodColor.kt`); видимость каждой можно переключить иконкой 👁 в карточке результата.
